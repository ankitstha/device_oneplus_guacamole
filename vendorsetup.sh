...
git clone https://github.com/Codecity001/Neptune_kernel_sm8150_oneplus.git kernel/oneplus/sm8150 --depth=1
echo ""
...
git clone https://github.com/Fraaxius/vendor_extra -b master vendor/extra
...
git clone https://github.com/ankitstha/vendor_aosp_signing_keys.git vendor/aosp/signing/keys --depth=1
echo ""
